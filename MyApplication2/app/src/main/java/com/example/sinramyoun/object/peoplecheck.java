...
public class peoplecheck extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pid = (EditText) findViewById(R.id.peoedit);
        ...
        Button some = (Button) findViewById(R.id.pcheck);
        some.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                HttpPostData();
                ListView list = (ListView) findViewById(R.id.plist);
    ...
    public void HttpPostData() {
        try {
            ...
            URL url = new URL("http://chanwoo.hust.net/carpfish/reservationpeoplecheckAnd.php");
            ...
            buffer.append("pid").append("=").append(pid.getText().toString());
